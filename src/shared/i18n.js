(() => {
  ...
  const FALLBACK_MESSAGES = {
    en: {
      ...
      sendDanmakuAria: "Send danmaku",
      sendDanmakuTitle: "Send danmaku",
      sendDanmakuPlaceholder: "Type a message, press Enter to send",
      sendDanmakuFailed: "Failed to send: $1",
      sendDanmakuLoginRequired: "Sign in to YouTube to send danmaku",
      logSendCommentFailed: "[Youtubi] Comment failed",
    ...
    zh_CN: {
      ...
      sendDanmakuAria: "发送弹幕",
      sendDanmakuTitle: "发送弹幕",
      sendDanmakuPlaceholder: "输入内容，回车发送",
      sendDanmakuFailed: "发送失败：$1",
      sendDanmakuLoginRequired: "请先登录 YouTube 再发送弹幕",
      logSendCommentFailed: "[Youtubi] 评论发送失败",
      replyLoading: "加载回复...",
      replyFailed: "回复加载失败",
      replyEmpty: "暂无回复",
      replyCount: "$1 条回复",
